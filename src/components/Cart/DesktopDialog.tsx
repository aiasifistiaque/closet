...
const DesktopDialog: React.FC<DesktopDialogProps> = ({
	...
	return (
		<HStack align='start' justify='space-between' gap={6} w='full'>
			{/* Left: Gallery - Desktop */}
			<HStack gap={4} align='start' w='50%' minW='400px'>
				<VStack gap={3} align='stretch' h={imageHeight} maxW={thumbnailSize}>
					{images.map((src, idx) => (
						<Image
							key={idx}
							src={src}
